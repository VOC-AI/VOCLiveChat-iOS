...
- (void)viewDidLoad
{
    ...
    VocaiChatModel *vocaiModel = [[VocaiChatModel alloc] initWithBotId:@"499" token:@"66D806CAE4B05062935CCFD0" email:@"anti2moron@gmail.com" language:@"zh-Hant-HK" otherParams:nil];
